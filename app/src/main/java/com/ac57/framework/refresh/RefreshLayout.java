...
import com.ac57.framework.refresh.util.RefreshScrollingUtil;
...
public class RefreshLayout extends LinearLayout {
     ...
     * 上拉加载是否可用
     */
    private boolean mPullUpRefreshEnable = true;
    ...
    public RefreshLayout(Context context, AttributeSet attrs) {
        ...
        initWholeHeaderView();
        setRefreshViewHolder(new CoustomRefreshViewHolder(context, true));
    }
    ...
    public void beginLoadingMore() {
        if (mPullUpRefreshEnable && !mIsLoadingMore && mLoadMoreFooterView != null && mDelegate != null && mDelegate.onBGARefreshLayoutBeginLoadingMore(this)) {
            mIsLoadingMore = true;
    ...
    public void setPullUpRefreshEnable(boolean pullUpRefreshEnable) {
        mPullUpRefreshEnable = pullUpRefreshEnable;
    }
