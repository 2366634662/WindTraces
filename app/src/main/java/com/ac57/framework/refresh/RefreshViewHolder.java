...
import com.ac57.R;
import com.ac57.framework.refresh.lodamoreview.BaseIndicatorController;
import com.ac57.framework.refresh.lodamoreview.LoadingIndicatorView;
...
public abstract class RefreshViewHolder {
    ...
    public View getLoadMoreFooterView() {
        ...
        if (mLoadMoreFooterView == null) {
            ...
            loadingIndicatorView = (LoadingIndicatorView) mLoadMoreFooterView.findViewById(R.id.loadmore_view);
        }
    ...
    public void changeToLoadingMore() {
        if (mIsLoadingMoreEnabled && loadingIndicatorView.mIndicatorController != null) {
            loadingIndicatorView.mIndicatorController.setAnimationStatus(BaseIndicatorController.AnimStatus.START);
        }
    }
    ...
    public void onEndLoadingMore() {
        if (mIsLoadingMoreEnabled && loadingIndicatorView.mIndicatorController != null) {
            loadingIndicatorView.mIndicatorController.setAnimationStatus(BaseIndicatorController.AnimStatus.END);
        }
    }
