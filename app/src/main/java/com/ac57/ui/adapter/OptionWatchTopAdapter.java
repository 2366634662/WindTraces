...
public class OptionWatchTopAdapter extends RecyclerAdapter<OptionWatchTopEntity.DataListBean> {
    ...
    public OptionWatchTopAdapter(Context context, @NonNull int... layoutResIds) {
        super(context, layoutResIds);

    }

    @Override
    protected void convert(RecyclerAdapterHelper helper, OptionWatchTopEntity.DataListBean item) {
        ...
        if (StringUtils.isNotEmpty(item.is_up)) {
            if (item.is_up.equals("102")) {
                tv_top_item_count.setTextColor(context.getResources().getColor(R.color.myoptional_green));
                tv_top_item_mess.setTextColor(context.getResources().getColor(R.color.myoptional_green));
            } else if (item.is_up.equals("101")) {
                tv_top_item_count.setTextColor(context.getResources().getColor(R.color.myoptional_red));
                tv_top_item_mess.setTextColor(context.getResources().getColor(R.color.myoptional_red));
            } else {
                tv_top_item_count.setTextColor(context.getResources().getColor(R.color.myoptional_yellow));
                tv_top_item_mess.setTextColor(context.getResources().getColor(R.color.myoptional_yellow));
            }
        }
