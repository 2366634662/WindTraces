...
/**
 * Created by Du_Li on 2016/11/18.
 * Desc: 所有的接口
 */
...
public class UrlUtils {
    ...
    //qq和微信登录
    public static final String THREE_LOGIN_INFO_URL = "Index/Login/tencent";
    //游客登录
    public static final String VISITOR_LOGIN = "Index/Login/visitor";
    //咨询顶部轮播图
