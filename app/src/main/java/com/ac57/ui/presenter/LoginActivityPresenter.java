...
public class LoginActivityPresenter extends BasePresenter<ILoginActivityViewController> {
    /**
    ...
    public LoginActivityPresenter(ILoginActivityViewController model, Activity activity) {
        super(model);
