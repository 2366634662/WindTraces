...
public class EasyStatusView extends RelativeLayout {
    ...
    private RabbitsView loading_view;
    ...
    protected void onFinishInflate() {
        ...
        loading_view = (RabbitsView) mLoadingView.findViewById(R.id.load_v);
        loading_view.setStat(1);
    ...
    private void changeViewStatus(int viewStatus) {
        if (viewStatus == STATUS_CONTENT) {
            ...
            if (viewStatus == STATUS_LOADING) {
                loading_view.setArrId(R.array.rabbits_arr);
                loading_view.setStat(2);
                loading_view.setAnimationStatus(RabbitsView.AnimStatus.START);
            } else {
                loading_view.setAnimationStatus(RabbitsView.AnimStatus.CANCEL);
            }
        }
    }
